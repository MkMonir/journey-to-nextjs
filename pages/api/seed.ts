...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Data>) {
  ...
  await prisma.restaurant.createMany({
    data: [
      // INDIAN //
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/1/32109459.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/47417441.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: 'Coconut Lagoon',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/48545745.jpg',
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/26429498.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/4/47914200.jpg',
        price: PRICE.EXPENSIVE,
        description:
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/49294128.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      {
        name: 'Utsav',
        mainImage: 'https://resizer.otstatic.com/v2/photos/xlarge/1/26646742.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: 'Pukka',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/1/25733300.jpg',
        price: PRICE.EXPENSIVE,
        description:
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/xlarge/1/25602522.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: 'Eldorado Taco',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/42557297.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      {
        name: 'La Bartola',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/48981502.jpg',
        price: PRICE.EXPENSIVE,
        description:
      ...
      {
        name: 'El Catrin',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/28028883.png',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: '3 Mariachis',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/32449465.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: 'Casa Madera',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/47744844.jpg',
        price: PRICE.EXPENSIVE,
        description:
      ...
      {
        name: 'Taco N Tequila',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/47429858.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: 'El Jefe',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/47710768.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      // ITALIAN //
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/43463549.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      {
        name: 'Blu Ristorante',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/2/47350167.jpg',
        price: PRICE.EXPENSIVE,
        description:
      ...
      {
        name: 'Stelvio',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/50557365.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/46827195.jpg',
        price: PRICE.REGULAR,
        description:
      ...
      {
        name: 'EST Restaurant',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/49169798.jpg',
        price: PRICE.CHEAP,
        description:
      ...
      {
        name: 'Sofia',
        mainImage: 'https://resizer.otstatic.com/v2/photos/xlarge/1/25558850.jpg',
        price: PRICE.EXPENSIVE,
        description:
      ...
      },
      {
        ...
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/49463645.png',
        price: PRICE.REGULAR,
        description:
      ...
      {
        name: 'il Padrino',
        mainImage: 'https://resizer.otstatic.com/v2/photos/wide-huge/3/49616181.jpg',
        price: PRICE.CHEAP,
        description:
  ...
  const vivaanId =
    restaurants.find((restaurant) => restaurant.name === 'Vivaan - fine Indian')?.id || 1;
  const RamaKrishnaId =
    restaurants.find((restaurant) => restaurant.name === 'RamaKrishna Indian')?.id || 1;
  const coconutLagoonId =
    restaurants.find((restaurant) => restaurant.name === 'Coconut Lagoon')?.id || 1;
  const lastTrainToDelhiId =
    restaurants.find((restaurant) => restaurant.name === 'Last Train to Delhi')?.id || 1;
  const adrakYorkvilleId =
    restaurants.find((restaurant) => restaurant.name === 'Adrak Yorkville')?.id || 1;
  const curryishTavernId =
    restaurants.find((restaurant) => restaurant.name === 'Curryish Tavern')?.id || 1;
  ...
  const kamasutraIndianId =
    restaurants.find((restaurant) => restaurant.name === 'Kamasutra Indian')?.id || 1;
  const eldoradoTacoId =
    restaurants.find((restaurant) => restaurant.name === 'Eldorado Taco')?.id || 1;
  ...
  const canoRestaurantId =
    restaurants.find((restaurant) => restaurant.name === 'Cano Restaurant')?.id || 1;
  const bluRistoranteId =
    restaurants.find((restaurant) => restaurant.name === 'Blu Ristorante')?.id || 1;
